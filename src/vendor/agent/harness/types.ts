import type { ImageContent, Model, SimpleStreamOptions, TextContent, Transport } from "../../ai/base.ts";
...
export interface Skill {
	...
	/** When true, the skill declares a workflow-based execution that should use multi-group planning (Path A). */
